import { AlertCircle, Check, Clock, Info, Minus } from "lucide-react";
...
// app. A static clock distinguishes pending work from a loading request.
//
...
const toneIcon: Record<StatusPillTone, ReactNode> = {
  ...
  progress: <Clock size={14} aria-hidden />,
...
export function StatusPill({ tone, children, icon }: { tone: StatusPillToneInput; children: ReactNode; icon?: ReactNode }) {
  ...
  return (
    <span className={toneClass[resolved]}>
